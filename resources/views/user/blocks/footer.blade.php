    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 aboutus col-sm-6">
          <h2>About Us </h2>
          <p> Đâu là shop bán giày lớn và uy tín nhất thế giới. Với tuổi đời 20 năm trong lĩnh vực bán giày.<br>
            <br>
            Website được xây dựng nhằm mục đích học tập, nội dung được lấy từ các trang khác
          </p>
        </div>
        <div class="col-lg-3 contact col-sm-6">
          ...
          <ul>
            ...
            <li class="email"> trinhdanh04@gmail.com </li>
  ...
  <section class="copyrightbottom">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 textright"> ShopSimple @ <?php echo date("Y");?> </div>
      </div>
    </div>
  </section>
